...
public class ParseSegment extends Configured
		implements
			Tool,
		...
		for (Entry<Text, Parse> entry : parseResult) {
			...
			try {
				...
				if (LOG.isWarnEnabled()) {
					LOG.warn("Error passing score: " + url + ": "
							+ e.getMessage());
				}
			}
	 ...
	 *         when it could be determined, <code>false</code>.
	 */
