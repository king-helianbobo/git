...
public class Injector extends Configured implements Tool {
	...
	public static class InjectReducer
		...
		public void reduce(Text key, Iterator<CrawlDatum> values,
			...
			if (injectedSet && oldSet && overwrite) {
				...
				if (update) {
					LOG.info(key.toString()
							+ " overwritten with injected record but update was specified.");
				}
			}
			...
			if (injectedSet && oldSet && update && !overwrite) {
				...
				old.setScore(injected.getScore() != scoreInjected ? injected
	...
	public static void main(String[] args) throws Exception {
		String[] parameters = {"/home/liubo/git/apache-nutch-1.7/crawl",
				"/home/liubo/git/apache-nutch-1.7/urls"};
