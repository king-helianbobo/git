...
public class SegmentReader extends Configured
	...
	public static class InputCompatMapper extends MapReduceBase
			implements
	...
	public static void main(String[] args) throws Exception {
		//args[0] = "-dump";
		//args[1] = "crawl/segments/20140114111958 crawl/segments/20140114111958-content";
		//args[2] = "crawl/segments/20140114111958-content";
		...
		switch (mode) {
			case MODE_DUMP :
				...
				if (input == null) {
					System.err
							.println("Missing required argument: <segment_dir>");
					usage();
					return;
				}
			...
			case MODE_LIST :
				...
				segmentReader.list(dirs, new OutputStreamWriter(System.out,
						"UTF-8"));
				return;
			case MODE_GET :
				input = args[1];
