...
;; ;; (add-to-list 'load-path "~/emacs-config/yasnippet")  
;; ;; (require 'yasnippet) ;; 
;; ;; (yas-global-mode 1)
;; ;; (yas-load-directory "~/emacs-config/yasnippet/snippets")
;; ;; (setq yas/prompt-functions '(yas/dropdown-prompt yas/x-prompt  yas/ido-prompt yas/completing-prompt)) ;;设置提示方式，文本/X


;; ;; (add-to-list 'load-path "~/emacs-config/auto-complete-1.3.1")
;; ;; (require 'auto-complete-config);;auto-complete-mode
;; ;; (add-to-list 'ac-dictionary-directories "~/emacs-config/auto-complete-1.3.1/ac-dict")
;; ;; (ac-config-default)
...
;; ;;my config file
;; (add-to-list 'load-path "~/emacs-config/auto-java-complete")
