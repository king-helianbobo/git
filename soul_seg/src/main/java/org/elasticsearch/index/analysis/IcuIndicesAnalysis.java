...
public class IcuIndicesAnalysis extends AbstractComponent {
	...
	@Inject
	public IcuIndicesAnalysis(Settings settings,
		...
		indicesAnalysisService.tokenFilterFactories().put("icu_normalizer",
				new PreBuiltTokenFilterFactoryFactory(new TokenFilterFactory() {
					...
					public TokenStream create(TokenStream tokenStream) {
						return new org.apache.lucene.analysis.icu.ICUNormalizer2Filter(
								tokenStream, Normalizer2.getInstance(null,
										"nfkc_cf", Normalizer2.Mode.COMPOSE));
					}
				}));
				...
				new PreBuiltTokenFilterFactoryFactory(new TokenFilterFactory() {
					...
					public TokenStream create(TokenStream tokenStream) {
						return new ICUTransformFilter(tokenStream,
								Transliterator.getInstance("Null",
