...
public class PinyinAbbreviationTokenizer extends CharTokenizer {
	...
	public PinyinAbbreviationTokenizer(Reader reader) {
	...
	protected int normalize(int c) {
		try {
			String[] strs = PinyinHelper.toHanyuPinyinStringArray((char) c,
					format);
			if (strs != null) {
