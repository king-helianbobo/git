...
public class MainSearchTest extends ElasticsearchIntegrationTest {
	...
	private static String filePath = "file:///home/liubo/git/soul_seg/target/releases/soul_seg-0.2-plugin.zip";

	private static final Settings SETTINGS = ImmutableSettings
			.settingsBuilder()
