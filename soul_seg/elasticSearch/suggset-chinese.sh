...
curl -X POST localhost:9200/bus/bus1?pretty -d '{ "name" : "麻辣鸡翅" }'
curl -X POST localhost:9200/bus/bus1?pretty -d '{ "name" : "麻辣烤翅" }'
curl -X POST localhost:9200/bus/bus1?pretty -d '{ "name" : "麻辣砂锅" }'
