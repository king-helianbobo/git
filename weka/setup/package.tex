...
%% use the paralist package to set the default left margins of lists/enumerates/etc. Simply use the command \setdefaultleftmargin like so
\usepackage{paralist}
\setdefaultleftmargin{0pt}{}{}{}{}{}
\usepackage{float} %%prohibit object float anywhere
\usepackage[linesnumbered,ruled]{algorithm2e}
...
\setCJKmainfont[AutoFakeBold={true},AutoFakeSlant={true}]{方正楷体_GBK}
...
\setCJKmonofont[AutoFakeBold={true},AutoFakeSlant={false},Scale=0.9]{方正楷体_GBK}
