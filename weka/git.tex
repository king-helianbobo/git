...
\end{verbatim}
\par Inside the POM's dependency section, we set Hadoop to the \textsl{\large provided} scope，这样的话，Hadoop相关的jar包就不会包含进来了，但功能尚未经过测试。
\begin{verbatim}
<dependencies>
  <dependency>
