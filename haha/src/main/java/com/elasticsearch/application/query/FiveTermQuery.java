...
public class FiveTermQuery extends SoulQuery {

	private static final Log log = LogFactory.getLog(FiveTermQuery.class);
	...
	public FiveTermQuery(Map<Integer, List<Map<String, Object>>> tokens) {
		super(tokens);
	}
	...
	private void fillLongList() {
		...
		keywords4 = resultMap.get(3);
		keywords5 = resultMap.get(4);
