...
public class AboutBlock extends HtmlBlock {
	...
	protected void render(Block html) {
		...
		info("Cluster overview")
				...
				._("ResourceManager started on:",
						Times.format(cinfo.getStartedOn()))
				._("ResourceManager version:",
						cinfo.getRMBuildVersion() + " on "
								+ cinfo.getRMVersionBuiltOn())
				._("Hadoop version:",
						cinfo.getHadoopBuildVersion() + " on "
								+ cinfo.getHadoopVersionBuiltOn());
