...
public class ApplicationAttemptStateDataPBImpl extends
		ProtoBase<ApplicationAttemptStateDataProto> implements
		ApplicationAttemptStateData {
	private static final RecordFactory recordFactory = RecordFactoryProvider
			.getRecordFactory(null);

	ApplicationAttemptStateDataProto proto = ApplicationAttemptStateDataProto
			.getDefaultInstance();
	...
	private void mergeLocalToBuilder() {
		if (this.attemptId != null) {
			builder.setAttemptId(((ApplicationAttemptIdPBImpl) attemptId)
					.getProto());
		}
		if (this.masterContainer != null) {
			builder.setMasterContainer(((ContainerPBImpl) masterContainer)
					.getProto());
		}
	...
	public ApplicationAttemptId getAttemptId() {
		ApplicationAttemptStateDataProtoOrBuilder p = viaProto ? proto
				: builder;
		if (attemptId != null) {
			return attemptId;
		}
	...
	public static ApplicationAttemptStateData newApplicationAttemptStateData(
			...
			ByteBuffer attemptTokens, long startTime,
			RMAppAttemptState finalState, String finalTrackingUrl,
			String diagnostics, FinalApplicationStatus amUnregisteredFinalStatus) {
		ApplicationAttemptStateData attemptStateData = recordFactory
				.newRecordInstance(ApplicationAttemptStateData.class);
	...
	public static RMAppAttemptState convertFromProtoFormat(
		...
		return RMAppAttemptState.valueOf(e.name().replace(
				RM_APP_ATTEMPT_PREFIX, ""));
	}
