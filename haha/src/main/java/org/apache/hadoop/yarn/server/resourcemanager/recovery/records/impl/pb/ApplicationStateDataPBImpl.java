...
public class ApplicationStateDataPBImpl extends
		ProtoBase<ApplicationStateDataProto> implements ApplicationStateData {
	private static final RecordFactory recordFactory = RecordFactoryProvider
			.getRecordFactory(null);

	ApplicationStateDataProto proto = ApplicationStateDataProto
			.getDefaultInstance();
	...
	public static ApplicationStateData newApplicationStateData(long submitTime,
		...
		ApplicationStateData appState = recordFactory
				.newRecordInstance(ApplicationStateData.class);
