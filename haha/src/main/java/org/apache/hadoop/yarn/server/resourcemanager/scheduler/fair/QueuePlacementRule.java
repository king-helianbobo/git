...
public abstract class QueuePlacementRule {
	 ...
	 * 
	 * @param args
	 *            Additional attributes of the rule's xml element other than
	 *            create.
	 */
	 ...
	 * @return The queue to place the app into. An empty string indicates that
	 *         we should continue to the next rule, and null indicates that the
	 *         app should be rejected.
	 */
	 ...
	 * @param groups
	 *            The groups of the user submitting the app.
	 * @return The name of the queue to assign the app to, or null to empty
	 *         string continue to the next rule.
	 */
	 ...
	 * 
	 * Match will be made on first secondary group that exist in queues
	 */
