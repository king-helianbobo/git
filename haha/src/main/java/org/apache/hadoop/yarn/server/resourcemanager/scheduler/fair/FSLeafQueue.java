...
public class FSLeafQueue extends FSQueue {
	private static final Log LOG = LogFactory.getLog(FSLeafQueue.class
			.getName());

	private final List<AppSchedulable> runnableAppScheds = // apps that are
															// runnable
	...
	public void setPolicy(SchedulingPolicy policy)
		...
		if (!SchedulingPolicy.isApplicableTo(policy,
				SchedulingPolicy.DEPTH_LEAF)) {
