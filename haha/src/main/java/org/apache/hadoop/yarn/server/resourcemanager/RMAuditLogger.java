...
public class RMAuditLogger {
	...
	static enum Keys {
		USER, OPERATION, TARGET, RESULT, IP, PERMISSIONS, DESCRIPTION, APPID, APPATTEMPTID, CONTAINERID
	}
	 ...
	 */
	static String createSuccessLog(String user, String operation,
			String target, ApplicationId appId, ApplicationAttemptId attemptId,
	 ...
	 * <br>
	 * <br>
	 *            Note that the {@link RMAuditLogger} uses tabs ('\t') as a
	 *            key-val delimiter and hence the value fields should not
	 *            contains tabs ('\t').
	 */
	...
	public static void logSuccess(String user, String operation, String target,
		...
		if (LOG.isInfoEnabled()) {
			LOG.info(createSuccessLog(user, operation, target, appId,
					attemptId, null));
		}
	}
	...
	public static void logFailure(String user, String operation, String perm,
		...
		if (LOG.isWarnEnabled()) {
			LOG.warn(createFailureLog(user, operation, perm, target,
					description, appId, null, containerId));
		}
	}
	...
	public static void logFailure(String user, String operation, String perm,
		...
		if (LOG.isWarnEnabled()) {
			LOG.warn(createFailureLog(user, operation, perm, target,
					description, appId, attemptId, null));
		}
	}
