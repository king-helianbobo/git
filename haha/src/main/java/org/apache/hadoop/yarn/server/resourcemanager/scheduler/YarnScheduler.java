...
/**
 * This interface is used by the components to talk to the scheduler for
 * allocating of resources, cleaning up resources.
 * 
 */
public interface YarnScheduler extends EventHandler<SchedulerEvent> {
	...
	/**
	 * The main api between the ApplicationMaster and the Scheduler. The
	 * ApplicationMaster is updating his future resource requirements and may
	 * release containers he doens't need.
	 * 
	 * @param appAttemptId
	 * @param ask
	 * @param release
	 ...
	 * 
	 * @param nodeId
	 * @return the {@link SchedulerNodeReport} for the node or null if nodeId
	 *         does not point to a defined node.
	 */
	@LimitedPrivate("yarn")
	@Stable
	...
	/**
	 * Check if the user has permission to perform the operation. If the user
	 * has {@link QueueACL#ADMINISTER_QUEUE} permission, this user can
	 * view/modify the applications in this queue
	 * 
	 * @param callerUGI
	 * @param acl
	 * @param queueName
