 ...
 * {@link RMContainerImpl} for an implementation. Containers may be in one of
 * several states, given in {@link RMContainerState}. An RMContainer instance
 * may exist even if there is no actual running container, such as when
 * resources are being reserved to fill space for a future container allocation.
 */
