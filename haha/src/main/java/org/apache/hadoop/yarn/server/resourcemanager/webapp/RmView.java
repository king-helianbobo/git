...
public class RmView extends TwoColumnLayout {
	...
	private String appsTableInit() {
		// id, user, name, queue, starttime, finishtime, state, status,
		// progress, ui
	...
	protected String getAppsTableColumnDefs() {
		...
		return sb
				...
				.append(", oLanguage : { \"sSearch\": \"搜索\",\"sInfo\": \"从 _START_ 到 _END_ /共 _TOTAL_ 条数据\",\"sLengthMenu\": \"每页显示 _MENU_ 条记录\",\"sZeroRecords\": \"抱歉， 没有找到\",\"sInfoEmpty\": \"没有数据\",\"oPaginate\":{\"sFirst\":\"首页\",\"sPrevious\":\"前一页\",\"sNext\":\"下一页\",\"sLast\":\"尾页\"},\"sZeroRecords\": \"没有检索到数据\"}")
				.toString();
