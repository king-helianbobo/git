...
/**
 * Handle webservices jersey exceptions and create json or xml response with the
 * ExceptionData.
 */
...
public class GenericExceptionHandler implements ExceptionMapper<Exception> {
	...
	public Response toResponse(Exception e) {
		...
		RemoteExceptionData exception = new RemoteExceptionData(e.getClass()
				.getSimpleName(), e.getMessage(), e.getClass().getName());
