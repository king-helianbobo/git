...
public class FairSchedulerConfiguration extends Configuration {
	...
	public static final Log LOG = LogFactory
			.getLog(FairSchedulerConfiguration.class.getName());
	...
	public static final String ALLOCATION_FILE = CONF_PREFIX
			+ "allocation.file";
	 ...
	 * configuration file
	 */
	protected static final String ALLOW_UNDECLARED_POOLS = CONF_PREFIX
	...
	protected static final String LOCALITY_THRESHOLD_NODE = CONF_PREFIX
	...
	protected static final String LOCALITY_THRESHOLD_RACK = CONF_PREFIX
	...
	protected static final String SIZE_BASED_WEIGHT = CONF_PREFIX
			+ "sizebasedweight";
	...
	public float getLocalityThresholdRack() {
		return getFloat(LOCALITY_THRESHOLD_RACK,
