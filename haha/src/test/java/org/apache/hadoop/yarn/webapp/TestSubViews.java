...
public class TestSubViews {
	...
	static public class MainView extends HtmlPage {
		...
		public void render(Page.HTML<_> html) {
			html.body().div()._(Sub1.class)._().div().i("inline text")
					._(Sub2.class)._()._()._();
		}
	}
	...
	public void testSubView() throws Exception {
		...
		PrintWriter out = injector.getInstance(HttpServletResponse.class)
				.getWriter();
		out.flush();
