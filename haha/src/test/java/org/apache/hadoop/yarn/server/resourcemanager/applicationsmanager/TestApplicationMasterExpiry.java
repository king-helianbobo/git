...
/**
 * A test case that tests the expiry of the application master. More tests can
 * be added to this.
 */
public class TestApplicationMasterExpiry {
	// private static final Log LOG =
	// LogFactory.getLog(TestApplicationMasterExpiry.class);
	...
	// }
	//
	// private class DummyLauncher implements
