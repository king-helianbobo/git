...
public class RMHATestBase extends ClientBaseWithFixes {
	...
	private static StateChangeRequestInfo requestInfo = new StateChangeRequestInfo(
	...
	private static class MyRMAppManager extends RMAppManager {
		...
		protected void submitApplication(
			...
			RMAppImpl application = new RMAppImpl(
					submissionContext.getApplicationId(), this.rmContext,
			...
			this.rmContext.getRMApps().put(
					submissionContext.getApplicationId(), application);
