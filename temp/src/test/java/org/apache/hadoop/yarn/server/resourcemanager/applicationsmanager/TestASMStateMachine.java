...
public class TestASMStateMachine {
	...
	// LogFactory.getLog(TestASMStateMachine.class);
	...
	// }
	//
	// private class DummyAMLaunchEventHandler implements
	...
	// }
	//
	// private class DummySNEventHandler implements
	// EventHandler<ASMEvent<SNEventType>> {
	// AppAttempt application;
