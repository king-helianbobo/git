...
import org.apache.hadoop.yarn.webapp.hamlet.HamletSpec.LinkType;
import org.apache.hadoop.yarn.webapp.hamlet.HamletSpec.Media;
...
public class TestHamlet {
	...
	public void testHamlet() {
		Hamlet h = newHamlet().title("test").h1("heading 1").p("#id.class")
				.b("hello").em("world!")._().div("#footer")
				._("Brought to you by").a("http://hostname/", "Somebody")._();
	...
	public void testEnumAttrs() {
		Hamlet h = newHamlet()
				...
				.title("test enum attrs").link().$rel("stylesheet")
				.$media(EnumSet.of(Media.screen, Media.print))
				.$type("text/css").$href("style.css")._().link()
				.$rel(EnumSet.of(LinkType.index, LinkType.start))
				.$href("index.html")._();
	...
	public void testScriptStyle() {
		Hamlet h = newHamlet().script("a.js").script("b.js")
	...
	public void testPreformatted() {
		Hamlet h = newHamlet().div().i("inline before pre").pre()
				._("pre text1\npre text2").i("inline in pre")
				._("pre text after inline")._().i("inline after pre")._();
	...
	public void testSubViews() {
		Hamlet h = newHamlet().title("test sub-views").div("#view1")
				._(TestView1.class)._().div("#view2")._(TestView2.class)._();
