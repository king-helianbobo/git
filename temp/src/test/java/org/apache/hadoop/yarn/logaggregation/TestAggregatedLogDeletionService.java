...
public class TestAggregatedLogDeletionService {
	...
	public void testDeletion() throws Exception {
		...
		FileStatus userDirStatus = new FileStatus(0, true, 0, 0, toKeepTime,
				userDir);
		...
		FileStatus app2Log1Status = new FileStatus(10, false, 1, 1,
				toDeleteTime, app2Log1);

		Path app2Log2 = new Path(app2Dir, "host2");
		FileStatus app2Log2Status = new FileStatus(10, false, 1, 1, toKeepTime,
				app2Log2);
		...
		FileStatus app3Log1Status = new FileStatus(10, false, 1, 1,
				toDeleteTime, app3Log1);

		Path app3Log2 = new Path(app3Dir, "host2");
		FileStatus app3Log2Status = new FileStatus(10, false, 1, 1,
				toDeleteTime, app3Log2);
		...
		FileStatus app4Log1Status = new FileStatus(10, false, 1, 1,
				toDeleteTime, app4Log1);

		Path app4Log2 = new Path(app4Dir, "host2");
		FileStatus app4Log2Status = new FileStatus(10, false, 1, 1,
				toDeleteTime, app4Log2);

		when(mockFs.listStatus(app4Dir)).thenReturn(
				new FileStatus[] { app4Log1Status, app4Log2Status });

		AggregatedLogDeletionService.LogDeletionTask task = new AggregatedLogDeletionService.LogDeletionTask(
				conf, 1800);
	...
	public void testRefreshLogRetentionSettings() throws IOException {
		...
		FileStatus app1Log1Status = new FileStatus(10, false, 1, 1,
				before2000Secs, app1Log1);
	...
	public void testCheckInterval() throws Exception {
		...
		Path app1Log1 = new Path(app1Dir, "host1");
		FileStatus app1Log1Status = new FileStatus(10, false, 1, 1, now,
				app1Log1);
		...
		// verify(mockFs,
		// timeout(10000).atLeast(4)).listStatus(any(Path.class));
