...
public class TestRPC {
	...
	private void test(String rpcClass) throws Exception {
		...
		ContainerTokenIdentifier containerTokenIdentifier = new ContainerTokenIdentifier(
				containerId, "localhost", "user", resource,
		...
		GetContainerStatusesResponse response = proxy
				.getContainerStatuses(gcsRequest);
		List<ContainerStatus> statuses = response.getContainerStatuses();

		// test remote exception
		boolean exception = false;
		try {
			StopContainersRequest stopRequest = recordFactory
					.newRecordInstance(StopContainersRequest.class);
	...
	public class DummyContainerManager implements ContainerManagementProtocol {
		...
		public GetContainerStatusesResponse getContainerStatuses(
			...
			GetContainerStatusesResponse response = recordFactory
					.newRecordInstance(GetContainerStatusesResponse.class);
		...
		public StopContainersResponse stopContainers(
			...
			Exception e = new Exception(EXCEPTION_MSG, new Exception(
					EXCEPTION_CAUSE));
	...
	public static ContainerTokenIdentifier newContainerTokenIdentifier(
		...
		org.apache.hadoop.security.token.Token<ContainerTokenIdentifier> token = new org.apache.hadoop.security.token.Token<ContainerTokenIdentifier>(
