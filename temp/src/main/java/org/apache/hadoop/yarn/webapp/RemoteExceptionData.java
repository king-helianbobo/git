...
/**
 * Contains the exception information from an exception thrown by the web
 * service REST API's. Fields include: exception - exception type javaClassName
 * - java class name of the exception message - a detailed message explaining
 * the exception
 * 
 */
