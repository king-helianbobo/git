...
/**
 * <code>CSQueue</code> represents a node in the tree of hierarchical queues in
 * the {@link CapacityScheduler}.
 */
@Stable
@Private
public interface CSQueue extends
	...
	/**
	 * Get capacity of the parent of the queue as a function of the cumulative
	...
	/**
	 * Get maximum-capacity of the queue as a funciton of the cumulative
	...
	/**
	 * Get the current absolute used capacity of the queue relative to the
	 * entire cluster.
	 * 
	...
	/**
	 * Get the currently utilized resources in the cluster by the queue and
	 * children (if any).
	 * 
	 ...
	 * @param container
	 *            completed container, <code>null</code> if it was just a
	 *            reservation
	 * @param containerStatus
	 *            <code>ContainerStatus</code> for the completed container
	 * @param childQueue
