...
/**
 * The interface to an Application in the ResourceManager. Take a look at
 * {@link RMAppImpl} for its implementation. This interface exposes methods to
 * access various updates in application status/report.
 */
public interface RMApp extends EventHandler<RMAppEvent> {
	 ...
	 * @return the {@link RMAppAttempt} corresponding to the
	 *         {@link ApplicationAttemptId}.
	 */
	 ...
	 * {@link ApplicationSubmissionContext#setQueue(String)}. This method
	 * returns the queue to which an application was submitted.
	 * 
	...
	/**
	 * Reflects a change in the application's queue from the one specified in
	 ...
	 * {@link ApplicationSubmissionContext#setApplicationName(String)}.
	 * 
