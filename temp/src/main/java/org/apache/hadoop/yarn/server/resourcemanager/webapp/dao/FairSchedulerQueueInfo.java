...
public class FairSchedulerQueueInfo {
	...
	public FairSchedulerQueueInfo(FSQueue queue, FairScheduler scheduler) {
		...
		maxResources = new ResourceInfo(Resources.componentwiseMin(
				queue.getMaxShare(), scheduler.getClusterCapacity()));
		...
		for (FSQueue child : children) {
			if (child instanceof FSLeafQueue) {
				childQueues.add(new FairSchedulerLeafQueueInfo(
						(FSLeafQueue) child, scheduler));
			} else {
	...
	/**
	 * Returns the queue's min share in as a fraction of the entire cluster
	 * capacity.
	 */
	...
	/**
	 * Returns the memory used by this queue as a fraction of the entire cluster
	 * capacity.
	 */
