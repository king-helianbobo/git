 ...
 * 
 * <p>
 * Generated from HTML 4.01 strict DTD and HTML5 diffs. <br>
 * cf. http://www.w3.org/TR/html4/ <br>
 * cf. http://www.w3.org/TR/html5-diff/
 * <p>
 * The omitted attributes and elements (from the 4.01 DTD) are for HTML5
 * compatibility.
 * 
 * <p>
 ...
 * 
 * <p>
 * The naming convention used in this class is slightly different from normal
 * classes. A CamelCase interface corresponds to an entity in the DTD.
...
public class HamletSpec {
   ...
   */
	...
	public interface HeadMisc extends _Script, _Object {
		...
		/**
		 * Add a meta element. Shortcut of
		 * <code>meta().$name(name).$content(content)._();</code>
		 * 
		 * @param name
		 *            of the meta element
		 * @param content
		...
		/**
		 * Add a meta element with http-equiv attribute. Shortcut of <br>
		...
		/**
		 * Add a link element. Implementation should try to figure out type by
		 * the suffix of href. So <code>link("style.css");</code> is a shortcut
		 * of
	...
	public interface _FontSize extends _Child {
		...
		/**
		 * Add a complete small (small print) element. Shortcut of:
		 * small()._(cdata)._();
		 * 
		 * @param cdata
		 *            the content of the element
		...
		/**
		 * Add a complete small (small print) element. Shortcut of:
		 * small().$id(id).$class(class)._(cdata)._();
		 * 
		 * @param selector
   ...
   */
	...
	/**
	 * INS and DEL are unusual for HTML "in that they may serve as either
	 * block-level or inline elements (but not both)". <br>
	 * cf. http://www.w3.org/TR/html4/struct/text.html#h-9.4 <br>
	 * cf. http://www.w3.org/TR/html5/edits.html#edits
	 */
   ...
   */
	public interface _Label extends _Child {
		...
		/**
		 * Add a LABEL element. Shortcut of
		 * <code>label().$for(forId)._(cdata)._();</code>
		 * 
		 * @param forId
		 *            the for attribute
		 * @param cdata
   ...
   */
	...
	/** %inline */
	public interface Inline extends PCData, FontStyle, Phrase, Special,
			FormCtrl {
	}
   ...
   */
	public interface _Param extends _Child {
		...
		/**
		 * Add a PARAM element. Shortcut of
		 * <code>param().$name(name).$value(value)._();</code>
		 * 
		 * @param name
		 *            of the value
		 * @param value
   ...
   */
	...
	_Script, _Block, _FieldSet {
		...
		/**
		 * contentype for "POST" method. The default is
		 * "application/x-www-form-urlencoded". Use "multipart/form-data" for
		 * input type=file
		 * 
		 * @param enctype
		 * @return the current element builder
   ...
   */
	public interface _Table extends _TableRow, _TableCol {
		...
		/**
		 * Add a tbody (table body) element. Must be after thead/tfoot and no tr
		 * at the same level.
		 * 
		...
		// $summary, width, border, frame, rules, cellpadding, cellspacing
		// omitted
		// use css instead
	}

	/**
	 * TBODY should be used after THEAD/TFOOT, iff there're no TABLE.TR
	 * elements.
	 */
