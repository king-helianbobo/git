...
/**
 * A reusable, pure-css, cross-browser, left nav, 2 column, supposedly liquid
 * layout. Doesn't quite work with resizable themes, kept as an example of the
	...
	protected void render(Page.HTML<_> html) {
		...
		html.title($("title"))
				...
				.style(".main { min-height: 100%; height: auto !important; height: 100%;",
						...
						"  right: 12em; overflow: hidden; }")._(JQueryUI.class);
		postHead(html);
		JQueryUI.jsnotice(html);
		html.div(".main.ui-widget-content")._(header()).div(".cmask.leftnav")
				.div(".c1right").div(".c1wrap").div(".content")._(content())
				._()._().div(".nav")._(nav()).div(".push")._()._()._()._()._()
				.div(".footer.ui-widget-content")._(footer())._()._();
	}
