...
public abstract class SchedulerNode {
	 ...
	 * {@link YarnConfiguration#RM_SCHEDULER_INCLUDE_PORT_IN_NODE_NAME}
	 * constant. The main usecase of this is Yarn minicluster to be able to
	 * differentiate node manager instances by their port number.
	 * 
