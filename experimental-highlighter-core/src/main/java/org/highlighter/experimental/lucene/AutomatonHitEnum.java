package org.highlighter.experimental.lucene;
...
public class AutomatonHitEnum implements HitEnum {
	...
	public static class Factory {
		...
		public AutomatonHitEnum build(String source, HitWeigher queryWeigher,
			...
			return new AutomatonHitEnum(run, source, queryWeigher,
					corpusWeigher);
		}
	}
	...
	public AutomatonHitEnum(OffsetReturningRunAutomaton runAutomaton,
			String source, HitWeigher queryWeigher, HitWeigher corpusWeigher) {
