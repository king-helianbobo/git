...
public class TestContainerLaunchRPC {
	...
	private void testRPCTimeout(String rpcClass) throws Exception {
		...
		try {
			...
			Token containerToken = TestRPC.newContainerToken(nodeId,
					"password".getBytes(), containerTokenIdentifier);
			...
			try {
				...
				Assert.assertEquals("Error, exception is not: "
						...
						SocketTimeoutException.class.getName(), e.getClass()
								.getName());
				return;
			}
		} finally {
	...
	public class DummyContainerManager implements ContainerManagementProtocol {
		...
		public StopContainersResponse stopContainers(
				StopContainersRequest requests) throws YarnException,
				IOException {
