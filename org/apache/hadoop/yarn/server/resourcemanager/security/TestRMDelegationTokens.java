...
public class TestRMDelegationTokens {
	...
	public void testRMDTMasterKeyStateOnRollingMasterKey() throws Exception {
		...
		RMDelegationTokenSecretManager dtSecretManager = rm1.getRMContext()
		...
		DelegationKey oldCurrentKey = ((TestRMDelegationTokenSecretManager) dtSecretManager)
				.getCurrentKey();

		// request to generate a RMDelegationToken
		GetDelegationTokenRequest request = mock(GetDelegationTokenRequest.class);
		when(request.getRenewer()).thenReturn("renewer1");
		GetDelegationTokenResponse response = rm1.getClientRMService()
				.getDelegationToken(request);
		org.apache.hadoop.yarn.api.records.Token delegationToken = response
		...
		DelegationKey newCurrentKey = ((TestRMDelegationTokenSecretManager) dtSecretManager)
				.getCurrentKey();
		...
		protected RMSecretManagerService createRMSecretManagerService() {
			return new RMSecretManagerService(conf, rmContext) {
				...
				protected RMDelegationTokenSecretManager createRMDelegationTokenSecretManager(
					...
					return new TestRMDelegationTokenSecretManager(1000, 1000,
							2000, 1000, rmContext);
				}
			};
		}
	...
	public class TestRMDelegationTokenSecretManager extends
		...
		public TestRMDelegationTokenSecretManager(
