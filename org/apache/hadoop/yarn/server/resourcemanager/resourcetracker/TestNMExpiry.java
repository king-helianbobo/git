...
public class TestNMExpiry {
	...
	public void setUp() {
		...
		RMContext context = new RMContextImpl(dispatcher, null, null, null,
				null, null, null, null, null, null);
		dispatcher.register(SchedulerEventType.class,
				new InlineDispatcher.EmptyEventHandler());
		dispatcher.register(RMNodeEventType.class, new NodeEventDispatcher(
				context));
		...
		resourceTrackerService = new ResourceTrackerService(context,
				nodesListManager, nmLivelinessMonitor,
		...
		public void run() {
			...
			while (!stopT) {
				try {
					...
					lastResponseID = resourceTrackerService.nodeHeartbeat(
