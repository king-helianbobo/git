...
public class TestSchedulerNegotiator {
	...
	// }
	//
	// private class DummyEventHandler implements
	...
	// waitForState(ApplicationState.LAUNCHING, masterInfo); // LAUNCHING
	// because ALLOCATED automatically movesto LAUNCHING for now.
