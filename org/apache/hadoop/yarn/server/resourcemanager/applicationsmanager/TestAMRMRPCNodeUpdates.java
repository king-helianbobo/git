...
public class TestAMRMRPCNodeUpdates {
	...
	public void testAMRMUnusableNodes() throws Exception {
		...
		AllocateRequest allocateRequest1 = AllocateRequest.newInstance(0, 0F,
				null, null, null);
		AllocateResponse response1 = allocate(attempt1.getAppAttemptId(),
				allocateRequest1);
		...
		allocateRequest1 = AllocateRequest.newInstance(
				response1.getResponseId(), 0F, null, null, null);
		...
		// allocate request returns no updated node
		AllocateRequest allocateRequest2 = AllocateRequest.newInstance(0, 0F,
				null, null, null);
		AllocateResponse response2 = allocate(attempt2.getAppAttemptId(),
				allocateRequest2);
		...
		allocateRequest2 = AllocateRequest.newInstance(
				response2.getResponseId(), 0F, null, null, null);
