...
public class TestAMLaunchFailure {
	...
	// LogFactory.getLog(TestAMLaunchFailure.class);
	...
	//
	// asmImpl = new ExtApplicationsManagerImpl(applicationTokenSecretManager,
	// scheduler);
	...
	// }
	//
	// private ApplicationSubmissionContext createDummyAppContext(ApplicationId
	// appID) {
