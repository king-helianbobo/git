...
public class TestLeafQueue {
	...
	public void setUp() throws Exception {
		...
		when(csContext.getClusterResources()).thenReturn(
			...
			public Container answer(InvocationOnMock invocation)
				...
				Container container = TestUtils.getMockContainer(containerId,
						((FiCaSchedulerNode) (invocation.getArguments()[1]))
								.getNodeID(), (Resource) (invocation
								.getArguments()[2]), ((Priority) invocation
								.getArguments()[3]));
				return container;
			}
		}).when(queue).createContainer(any(FiCaSchedulerApp.class),
				any(FiCaSchedulerNode.class), any(Resource.class),
				any(Priority.class));
	...
	public void testSingleQueueOneUserMetrics() throws Exception {
		...
		FiCaSchedulerApp app_0 = new FiCaSchedulerApp(appAttemptId_0, user_0,
				a, mock(ActiveUsersManager.class), rmContext);
		a.submitApplicationAttempt(app_0, user_0);

		final ApplicationAttemptId appAttemptId_1 = TestUtils
				.getMockApplicationAttemptId(1, 0);
		FiCaSchedulerApp app_1 = new FiCaSchedulerApp(appAttemptId_1, user_0,
				a, mock(ActiveUsersManager.class), rmContext);
	...
	public void testUserQueueAcl() throws Exception {
		...
		FiCaSchedulerApp app_0 = new FiCaSchedulerApp(appAttemptId_0, user_d,
				d, null, rmContext);
		...
		FiCaSchedulerApp app_1 = new FiCaSchedulerApp(appAttemptId_1, user_d,
				d, null, rmContext);
	...
	public void testAppAttemptMetrics() throws Exception {
		...
		FiCaSchedulerApp app_0 = new FiCaSchedulerApp(appAttemptId_0, user_0,
				a, null, rmContext);
		AppAddedSchedulerEvent addAppEvent = new AppAddedSchedulerEvent(
				appAttemptId_0.getApplicationId(), a.getQueueName(), user_0);
	...
	public void testSingleQueueWithOneUser() throws Exception {
		...
		assertEquals((int) (a.getCapacity() * node_0.getTotalResource()
	...
	public void testUserLimits() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_0 = TestUtils
				.getMockApplicationAttemptId(0, 0);
		FiCaSchedulerApp app_0 = new FiCaSchedulerApp(appAttemptId_0, user_0,
				a, a.getActiveUsersManager(), rmContext);
		a.submitApplicationAttempt(app_0, user_0);
		...
		FiCaSchedulerApp app_2 = new FiCaSchedulerApp(appAttemptId_2, user_1,
				a, a.getActiveUsersManager(), rmContext);
		...
		assertEquals("There should only be 1 active user!", 1, a
	...
	public void testHeadroomWithMaxCap() throws Exception {
		...
		assertEquals(2 * GB, app_0.getCurrentConsumption().getMemory());
		assertEquals(0 * GB, app_1.getCurrentConsumption().getMemory());
		assertEquals(0 * GB, app_0.getHeadroom().getMemory()); // User limit =
																// 2G
		assertEquals(0 * GB, app_0.getHeadroom().getMemory()); // User limit =
																// 2G
		...
		app_1.updateResourceRequests(Collections.singletonList( // unset
				TestUtils.createResourceRequest(ResourceRequest.ANY, 1 * GB, 0,
						true, priority, recordFactory)));
		assertEquals(1, a.getActiveUsersManager().getNumActiveUsers());
		a.assignContainers(clusterResource, node_1);
		assertEquals(1 * GB, app_2.getHeadroom().getMemory()); // hit queue
																// max-cap
	}
	...
	public void testSingleQueueWithMultipleUsers() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_3 = TestUtils
				.getMockApplicationAttemptId(3, 0);
		FiCaSchedulerApp app_3 = new FiCaSchedulerApp(appAttemptId_3, user_2,
				a, a.getActiveUsersManager(), rmContext);
	...
	public void testReservation() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_1 = TestUtils
				.getMockApplicationAttemptId(1, 0);
		FiCaSchedulerApp app_1 = new FiCaSchedulerApp(appAttemptId_1, user_1,
				a, mock(ActiveUsersManager.class), rmContext);
		...
		a.completedContainer(clusterResource, app_0, node_0, app_0
				.getLiveContainers().iterator().next(), null,
	...
	public void testStolenReservedContainer() throws Exception {
		...
		ArrayList<ResourceRequest> appRequests_1 = new ArrayList<ResourceRequest>(
				4);
		appRequests_1.add(TestUtils.createResourceRequest(host_0, 4 * GB, 1,
				true, priority, recordFactory));
		appRequests_1.add(TestUtils.createResourceRequest(DEFAULT_RACK, 4 * GB,
				1, true, priority, recordFactory));
		appRequests_1.add(TestUtils.createResourceRequest(ResourceRequest.ANY,
				4 * GB, 2, true, priority, recordFactory));
	...
	public void testReservationExchange() throws Exception {
		...
		assertEquals(4 * GB, app_1.getCurrentReservation().getMemory());
		assertEquals(4 * GB, node_1.getUsedResource().getMemory());
		// Doesn't change yet... only when reservation is cancelled or a
		// different
		...
		assertEquals(4 * GB, assignment.getExcessReservation().getContainer()
	...
	public void testLocalityScheduling() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_0 = TestUtils
				.getMockApplicationAttemptId(0, 0);
		FiCaSchedulerApp app_0 = spy(new FiCaSchedulerApp(appAttemptId_0,
				user_0, a, mock(ActiveUsersManager.class), rmContext));
		a.submitApplicationAttempt(app_0, user_0);

		// Setup some nodes and racks
		String host_0 = "127.0.0.1";
		String rack_0 = "rack_0";
		FiCaSchedulerNode node_0 = TestUtils.getMockNode(host_0, rack_0, 0,
				8 * GB);

		String host_1 = "127.0.0.2";
		String rack_1 = "rack_1";
		FiCaSchedulerNode node_1 = TestUtils.getMockNode(host_1, rack_1, 0,
				8 * GB);
		...
		app_0_requests_0.add(TestUtils.createResourceRequest(rack_1, 1 * GB, 1,
				true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(
				ResourceRequest.ANY, 1 * GB, 3, // one extra
				true, priority, recordFactory));
		...
		verify(app_0, never()).allocate(any(NodeType.class), eq(node_2),
				any(Priority.class), any(ResourceRequest.class),
				any(Container.class));
		...
		verify(app_0).allocate(eq(NodeType.OFF_SWITCH), eq(node_2),
				any(Priority.class), any(ResourceRequest.class),
				any(Container.class));
		assertEquals(4, app_0.getSchedulingOpportunities(priority)); // should
																		// NOT
																		// reset
		...
		app_0_requests_0.add(TestUtils.createResourceRequest(rack_1, 1 * GB, 1,
				true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(
				ResourceRequest.ANY, 1 * GB, 2, // one extra
				true, priority, recordFactory));
		app_0.updateResourceRequests(app_0_requests_0);
		assertEquals(2, app_0.getTotalRequiredResources(priority));

		String host_3 = "127.0.0.4"; // on rack_1
		FiCaSchedulerNode node_3 = TestUtils.getMockNode(host_3, rack_1, 0,
				8 * GB);
	...
	public void testApplicationPriorityScheduling() throws Exception {
		...
		app_0_requests_0.add(TestUtils.createResourceRequest(host_2, 2 * GB, 1,
				true, priority_2, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(rack_2, 2 * GB, 1,
				true, priority_2, recordFactory));
		app_0_requests_0.add(TestUtils
				.createResourceRequest(ResourceRequest.ANY, 2 * GB, 1, true,
	...
	public void testSchedulingConstraints() throws Exception {
		...
		FiCaSchedulerNode node_0_1 = TestUtils.getMockNode(host_0_1, rack_0, 0,
				8 * GB);

		String host_1_0 = "127.0.0.3";
		String rack_1 = "rack_1";
		FiCaSchedulerNode node_1_0 = TestUtils.getMockNode(host_1_0, rack_1, 0,
				8 * GB);
		...
		Priority priority = TestUtils.createMockPriority(1);
		List<ResourceRequest> app_0_requests_0 = new ArrayList<ResourceRequest>();
		app_0_requests_0.add(TestUtils.createResourceRequest(host_0_0, 1 * GB,
				1, true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(host_0_1, 1 * GB,
				1, true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(rack_0, 1 * GB, 1,
				true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(host_1_0, 1 * GB,
				1, true, priority, recordFactory));
		app_0_requests_0.add(TestUtils.createResourceRequest(rack_1, 1 * GB, 1,
				true, priority, recordFactory));
		app_0.updateResourceRequests(app_0_requests_0);
		...
		app_0_requests_0.clear();
		app_0_requests_0.add(TestUtils.createResourceRequest(
				ResourceRequest.ANY, 1 * GB, 1, // only one
				true, priority, recordFactory));
		app_0.updateResourceRequests(app_0_requests_0);
		...
		verify(app_0, never()).allocate(any(NodeType.class), eq(node_1_0),
				any(Priority.class), any(ResourceRequest.class),
				any(Container.class));
		assertEquals(0, app_0.getSchedulingOpportunities(priority)); // Still
																		// zero
																		// since
																		// #req=0
		assertEquals(0, app_0.getTotalRequiredResources(priority));
	...
	public void testActivateApplicationAfterQueueRefresh() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_0 = TestUtils
				.getMockApplicationAttemptId(0, 0);
		FiCaSchedulerApp app_0 = new FiCaSchedulerApp(appAttemptId_0, user_e,
				e, mock(ActiveUsersManager.class), rmContext);
		e.submitApplicationAttempt(app_0, user_e);

		final ApplicationAttemptId appAttemptId_1 = TestUtils
				.getMockApplicationAttemptId(1, 0);
		FiCaSchedulerApp app_1 = new FiCaSchedulerApp(appAttemptId_1, user_e,
				e, mock(ActiveUsersManager.class), rmContext);
		e.submitApplicationAttempt(app_1, user_e); // same user

		final ApplicationAttemptId appAttemptId_2 = TestUtils
				.getMockApplicationAttemptId(2, 0);
		FiCaSchedulerApp app_2 = new FiCaSchedulerApp(appAttemptId_2, user_e,
				e, mock(ActiveUsersManager.class), rmContext);
	...
	public void testActivateApplicationByUpdatingClusterResource()
		...
		e.updateClusterResource(Resources.createResource(200 * 16 * GB,
				100 * 32));
	...
	public void testInheritedQueueAcls() throws IOException {
		...
		assertTrue(hasQueueACL(a.getQueueUserAclInfo(user),
				QueueACL.SUBMIT_APPLICATIONS));
	...
	public void testLocalityConstraints() throws Exception {
		...
		final ApplicationAttemptId appAttemptId_1 = TestUtils
				.getMockApplicationAttemptId(1, 0);
		FiCaSchedulerApp app_1 = spy(new FiCaSchedulerApp(appAttemptId_1,
				user_0, a, mock(ActiveUsersManager.class), rmContext));
		...
		FiCaSchedulerNode node_1_1 = TestUtils.getMockNode(host_1_1, rack_1, 0,
				8 * GB);
	...
	public void testMaxAMResourcePerQueuePercentAfterQueueRefresh()
		...
		Resource clusterResource = Resources.createResource(100 * 16 * GB,
				100 * 32);
		CapacitySchedulerContext csContext = mockCSContext(csConf,
				clusterResource);
		csConf.setFloat(
				CapacitySchedulerConfiguration.MAXIMUM_APPLICATION_MASTERS_RESOURCE_PERCENT,
				0.1f);
	...
	public void testAllocateContainerOnNodeWithoutOffSwitchSpecified()
		...
		app_0.updateResourceRequests(Arrays.asList(TestUtils
				.createResourceRequest("127.0.0.1", 1 * GB, 3, true, priority,
						recordFactory), TestUtils.createResourceRequest(
				DEFAULT_RACK, 1 * GB, 3, true, priority, recordFactory)));
