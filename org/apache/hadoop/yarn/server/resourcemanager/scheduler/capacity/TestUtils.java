...
public class TestUtils {
	...
	public static RMContext getMockRMContext() {
		...
		// No op
		ContainerAllocationExpirer cae = new ContainerAllocationExpirer(
				nullDispatcher);

		Configuration conf = new Configuration();
		RMApplicationHistoryWriter writer = mock(RMApplicationHistoryWriter.class);
		RMContext rmContext = new RMContextImpl(nullDispatcher, cae, null,
				null, null, new AMRMTokenSecretManager(conf),
	...
	public static ResourceRequest createResourceRequest(String resourceName,
			int memory, int numContainers, boolean relaxLocality,
	...
	public static ContainerId getMockContainerId(FiCaSchedulerApp application) {
		...
		doReturn(application.getApplicationAttemptId()).when(containerId)
