...
public class TestMaxRunningAppsEnforcer {
	...
	public void testRemoveEnablesAppOnCousinQueue() {
		FSLeafQueue leaf1 = queueManager.getLeafQueue(
				"root.queue1.subqueue1.leaf1", true);
		FSLeafQueue leaf2 = queueManager.getLeafQueue(
				"root.queue1.subqueue2.leaf2", true);
	...
	public void testRemoveEnablesOneByQueueOneByUser() {
		FSLeafQueue leaf1 = queueManager
				.getLeafQueue("root.queue1.leaf1", true);
		FSLeafQueue leaf2 = queueManager
				.getLeafQueue("root.queue1.leaf2", true);
	...
	public void testMultiListStartTimeIteratorEmptyAppLists() {
		...
		Iterator<FSSchedulerApp> iter = new MaxRunningAppsEnforcer.MultiListStartTimeIterator(
				lists);
