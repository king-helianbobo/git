...
public class TestRPCFactories {
	...
	private void testPbServerFactory() {
		...
		Server server = null;
		try {
			server = RpcServerFactoryPBImpl.get().getServer(
					ApplicationMasterProtocol.class, instance, addr, conf,
					null, 1);
			server.start();
	...
	private void testPbClientFactory() {
		...
		try {
			...
			try {
				amrmClient = (ApplicationMasterProtocol) RpcClientFactoryPBImpl
						.get().getClient(ApplicationMasterProtocol.class, 1,
