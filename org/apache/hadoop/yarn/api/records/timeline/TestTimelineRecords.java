...
public class TestTimelineRecords {
	...
	public void testEvents() throws Exception {
		...
		TimelineEvents.EventsOfOneEntity partEvents1 = events.getAllEvents()
				.get(0);
		...
		TimelineEvents.EventsOfOneEntity partEvents2 = events.getAllEvents()
				.get(1);
	...
	public void testTimelinePutErrors() throws Exception {
		...
		LOG.info(TimelineUtils
				.dumpTimelineRecordtoJSON(TimelinePutErrors, true));
